      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="lg:grid lg:grid-cols-12 lg:gap-8">
          <div className="lg:col-span-8">
            <h1 className="text-3xl font-extrabold tracking-tight sm:text-4xl">{cruise.name}</h1>
            <div className="flex flex-wrap items-center mt-2 text-sm text-muted-foreground">
              ...
              <div className="flex items-center mb-2">
                ...
                <span className="flex items-center">{cruise.rating.toFixed(1)} ({cruise.reviewCount} reviews)</span>
              </div>
            </div>
            <div className="mt-6 relative">
              <img className="w-full h-96 object-cover rounded-lg" src={cruise.image} alt={cruise.name} />
            </div>
            <div className="mt-8">
