...
export const cruises = pgTable("cruises", {
  ...
  rating: doublePrecision("rating").default(0), // 0-5 scale
...
export const bookings = pgTable("bookings", {
  ...
  cabinType: text("cabin_type").notNull(), // interior, oceanview, balcony, suite
...
// Booking with calculated price schema
